...
import {ASYNC_KEY_VALUE_STORAGE_INJECTION_TOKEN, KeyValueStorage} from './signal-protocol-store/storages/key-value-storage';
...
@NgModule({
  ...
  providers: [{
    ...
    provide: ASYNC_KEY_VALUE_STORAGE_INJECTION_TOKEN
  }
    , {
